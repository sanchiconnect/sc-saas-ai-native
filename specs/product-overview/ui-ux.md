...
**Note (U-1, resolved 2026-07-27 — Linear SAN-58):** BS5-vs-BS4 and the CRUD-engine's inline styling are accepted as permanent (see §4). Only the `aic-` system's lack of shared stylesheet/breakpoints is being fixed, tracked separately as Linear SAN-65.
